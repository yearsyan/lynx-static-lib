...
class LynxStaticDemoConan(ConanFile):
    ...
    def requirements(self) -> None:
        self.requires("lynxlib/0.2.2@neuyan/stable")
        self.requires("lynxlib-runtime/0.2.2@neuyan/stable")
        self.requires("lynxlib-http/0.2.2@neuyan/stable")

    def configure(self) -> None:
        self.options["lynxlib"].flavor = "dev"
